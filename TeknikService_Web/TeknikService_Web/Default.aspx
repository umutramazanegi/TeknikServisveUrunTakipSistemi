<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TeknikService_Web.Default" %>
...
<body>
    <div class="sidenav">
		...
		<div class="col-4 side_top_left">
			<img src="web/images/computer1.jpg" alt="news image" class="img-fluid navimg">
		</div>
...
<section class="slide-wrapper" id="about">
	...
	<img src="web/images/ben.png" class="img-fluid" alt="">
	<p class="iner mt-5"> 
            ...
            <div class="cpy-right text-center">
                <div class="follow">
                    <ul class="social_section_1info">
                        <li><a href="https://x.com/umutqqx"><span class="fa fa-twitter"></span></a></li>
                        <li><a href="https://tr.linkedin.com/in/umutramazanegi"><span class="fa fa-linkedin"></span></a></li>
                    </ul>
                </div>
                <p>
